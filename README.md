...
先切换至root账户，然后执行以下代码
  ...
  bash <(curl -L https://cdn.jsdelivr.net/gh/kt007007/KTMinerProxy@0.0.493/linux-install.sh) -cn
  ```
...
bash <(curl -L https://cdn.jsdelivr.net/gh/kt007007/KTMinerProxy@0.0.493/linux-install.sh) -update
```
...
bash <(curl -L https://cdn.jsdelivr.net/gh/kt007007/KTMinerProxy@0.0.493/linux-install.sh) -uninstall
````
